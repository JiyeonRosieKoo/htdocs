    ...
    <div class="form_wrapper">
      <div class="form-des">
        ...
        <ul class="list-group list-group-flush form-des-list">
          ...
          while($row = mysqli_fetch_assoc($result)){
            echo "<a class='target5' href='http://localhost:8080/Rosie/app.php?id=".$row['id']."'><li>".htmlspecialchars($row['title'])."</li></a>";
          }
          ?>
          <a class="btn btn-secondary" href="http://localhost:8080/Rosie/appWrite.php">Add</a>
        </ul>
        <style type="text/css">
      ...
      <div class="form-main" id="body">
        <div class="app-des">
          ...
          <script src="http://localhost:8080/Rosie/app.js"></script>
        </div>
